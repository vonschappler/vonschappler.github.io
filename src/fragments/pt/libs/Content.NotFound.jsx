    ...
    >
      ...
      >
        <Grid item className="w-full">
          <Title divider>
            <h1 className="text-center">Eu não sei o que aconteceu...</h1>
          </Title>
        </Grid>
      </Grid>
      <Grid
      ...
      >
        <p>
          ... mas acredito que o endereço digitado <strong>{path}</strong> foi
          inserido erroneamente, pois essa página não existe nesse site.
        </p>
        <p>
          Se você acredita que digitou o endereço correto, por favor entre em{" "}
          <NavLink
            to="/contact"
            target="_blank"
          ...
          , me dizendo qual link está tentando acessar.
        </p>
      </Grid>
